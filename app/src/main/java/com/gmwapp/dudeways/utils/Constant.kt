...
object Constant {
    ...
    const val ADD_POINTS_REQUEST = MainBaseUrl + "dwpay/add_points_requests.php"
    ...
    const val SETTINGS_LIST: String = "api/settings_list"
    const val PRIVACY_POLICY: String =  "api/privacy_policy"
    const val REFUND_POLICY: String = "api/refund_policy"
    ...
    const val VERIFY_SELFIE_IMAGE: String = "api/verify_selfie_image"
    const val TRIP_LIST: String = "api/trip_list"
    const val ACTIVE_USERS_LIST: String = "api/active_users_list"
    const val USERS_LIST: String = "api/users_list"
    const val UPDATE_LOCATION: String = "api/update_location"
    const val ADD_FEEDBACK: String = "api/add_feedback"
    const val ADD_CHAT: String = "api/add_chat"
    const val DELETE_CHAT: String = "api/delete_chat"
    const val POINTS_LIST: String = "api/points_list"
    const val ADD_POINTS: String = BaseUrl + "add_points"
    const val SPIN_POINTS: String = "api/spin_points"
    const val REWARD_POINTS: String = "api/reward_points"
    ...
    const val MY_TRIP_LIST: String = "api/my_trip_list"
    const val DELETE_TRIP: String = "api/delete_trip"
    ...
    const val ADD_TRIP: String = "api/add_trip"
    const val UPDATE_TRIP_IMAGE: String = "api/update_trip_image"
    ...
    const val APPUPDATE: String = "api/appsettings_list"
    ...
    const val PLAN_LIST: String = "api/plan_list"
    const val PAYMENT_IMAGE_API: String = "api/payment_image"
