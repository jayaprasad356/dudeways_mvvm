...
object Constant {
    ...
    const val PROFESSION_LIST: String = "profession_list"
    ...
    const val CHECK_EMAIL: String = "check_email"
    const val USERDETAILS: String = "userdetails"
    const val OTHER_USER_DETAILS: String = "other_userdetails"
    const val SETTINGS_LIST: String = "settings_list"
    ...
    const val UPDATE_IMAGE: String = "update_image"
    ...
    const val TRIP_LIST: String = "trip_list"
    const val ACTIVE_USERS_LIST: String = "active_users_list"
    const val USERS_LIST: String = BaseUrl + "users_list"
    const val UPDATE_LOCATION: String = "update_location"
    ...
    const val REWARD_POINTS: String = "reward_points"
    ...
    const val MY_TRIP_LIST: String = "my_trip_list"
    const val DELETE_TRIP: String = "delete_trip"
    const val FREINDS_LIST: String = "friends_list"
    ...
    const val READ_CHATS: String = "read_chats"
    const val UNREAD_ALL: String = "unread_all"
    const val PROFILE_VIEW: String = BaseUrl + "profile_view"
    const val ADD_TRIP: String = "add_trip"
    const val UPDATE_TRIP_IMAGE: String = "update_trip_image"
